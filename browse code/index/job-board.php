...
<body>
    ...
    <p>Apply now!</p>
    <hr>
    <img  class="sideimg" src="img\Job hunt-cuate.png" alt="">
    <div class="display">
        <div id="job">
                <table class="table" >
                    <thead>
    ...
    <div class="footer">
        <div class="icon">
             <img src="img\facebook icon.png" alt="">     <img src="img\in icon.png" alt="">     <img src="img\twitter icon.png" alt="">     <img src="img\insta icon.png" alt="">
        </div>
        <div class="move">
